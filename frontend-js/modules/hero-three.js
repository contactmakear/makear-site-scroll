...
export default function heroThreeJs() {
  let redMaterial, blueMaterial, yellowMaterial;
  ...
  // const texture = textureLoader.load("./assets/texture/galaxy.jpg");
  ...
  //   renderer.setClearColor("#2b2e3a");
  renderer.setClearColor("#d6d6d6");
  ...
  blueMaterial = new THREE.MeshPhysicalMaterial({
    color: "#e11b4c",
    // map: texture,
    roughness: 0.5,
    reflectivity: 0.5,
  ...
  yellowMaterial = new THREE.MeshPhysicalMaterial({
    color: "#e11b4c",
    // map: texture,
    roughness: 0.5,
    reflectivity: 0.5,
